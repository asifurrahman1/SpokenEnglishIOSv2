...
class MenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        //***********************COLOR*********************************
        cv.backgroundColor = Colors.TopBar//UIColor(red: 255/255, green: 213/255, blue: 131/255, alpha: 1)
    ...
    let cellId = "cellId"
    let imageNames = ["account","tutorial","dictionary","quiz"]
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        //######################################################################
        cell.tintColor = Colors.TopBar//UIColor(red: 255/255, green: 213/255, blue: 131/255, alpha: 1)
...
class MenuCell: BaseCell {
    ...
    let imageView: UIImageView = {
        ...
        iv.tintColor = UIColor.rgb(0, green: 14, blue: 13)
        return iv
    }()
    
    override var highlighted: Bool {
        didSet {
            imageView.tintColor = highlighted ? UIColor.whiteColor() : UIColor.rgb(0, green: 14, blue: 13)
        }
    }
    
    override var selected: Bool {
        didSet {
            imageView.tintColor = selected ? UIColor.whiteColor() : UIColor.rgb(0, green: 14, blue: 13)
        }
    }
